...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.presetsLayout = QVBoxLayout(self.presets_tab)
        self.presetsLayout.setObjectName(u"presetsLayout")
        self.presetsList = QListWidget(self.presets_tab)
        ...
        sizePolicy9.setHeightForWidth(self.presetsList.sizePolicy().hasHeightForWidth())
        self.presetsList.setSizePolicy(sizePolicy9)
        ...
        self.applyPresetButton = QPushButton(self.presets_tab)
        self.applyPresetButton.setObjectName(u"applyPresetButton")

        self.presetsButtonsLayout.addWidget(self.applyPresetButton)

        self.savePresetButton = QPushButton(self.presets_tab)
        self.savePresetButton.setObjectName(u"savePresetButton")

        self.presetsButtonsLayout.addWidget(self.savePresetButton)

        self.overwritePresetButton = QPushButton(self.presets_tab)
        self.overwritePresetButton.setObjectName(u"overwritePresetButton")

        self.presetsButtonsLayout.addWidget(self.overwritePresetButton)


        self.presetsLayout.addLayout(self.presetsButtonsLayout)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"VisoMaster v0.1.5", None))
...
#if QT_CONFIG(tooltip)
        self.viewFullScreenButton.setToolTip(QCoreApplication.translate("MainWindow", u"View Full Screen (F11)", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.overwritePresetButton.setText(QCoreApplication.translate("MainWindow", u"Overwrite Selected", None))
